...
public class DepartmentController {
    ...
    @GetMapping("")
    public ResponseEntity<List<DepartmentDto>> get(@RequestParam(value = "pageNumber",defaultValue = "0",required = false) Integer pageNumber,
    ...
    //    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PutMapping("/{id}")
    public ResponseEntity<DepartmentDto> updateById(@RequestBody DepartmentDto departmentDto , @PathVariable Long id) throws Exception {
