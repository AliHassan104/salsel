    ...
    this.model = [
      {
        ...
        items: [
          ...
          },
          {
            ...
            permission: "CREATE_DEPARTMENT_CATEGORY",
          },
          {
            label: "Ticket Category",
            icon: "pi pi-map",
            routerLink: "ticket-category/list",
            permission: "CREATE_TICKET_CATEGORY",
          },
          {
            label: "Ticket Sub Category",
            icon: "pi pi-server",
            routerLink: "ticket-sub-category/list",
            permission: "CREATE_TICKET_SUB_CATEGORY",
          },
          {
            label: "Country",
          ...
          },
          {
            ...
            permission: "CREATE_PRODUCT_TYPE",
          },
          {
            label: "Service Type",
            icon: "pi pi-cog",
            routerLink: "service-type/list",
            permission: "CREATE_SERVICE_TYPE",
          },
          {
            label: "Permission",
            icon: "pi pi-shield",
