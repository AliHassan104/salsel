...
export class AccountFormComponent implements OnInit, AfterViewInit {
  ...
  getAllCities(countryName?: any) {
    this.cityService.getAllCities(this.params).subscribe((res?: any) => {
      ...
      this.filterCities = this.dropdownService.extractNames(filterCities);
    });
  }
  ...
  getAllProductFields() {
    ...
    this.countryService.getAllCountries(this.params).subscribe((res?: any) => {
      ...
      this.filterCountries = this.dropdownService.extractNames(this.countries);
    });
  }
    ...
    if (
      ...
      if (this.editMode) {
        ...
        this.messageService.add({
          severity: "error",
          summary: "Error",
          detail: "More Than One Account Not Allowed",
        });
      }
    } else {
      this.alert();
